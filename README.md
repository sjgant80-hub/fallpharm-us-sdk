...
**FallPharm · sovereign single-file US independent pharmacy OS** — sovereign SDK extracted from `fallpharm-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallpharm-us-sdk
```

## Use
```js
import * as fallpharm-us from '@ai-native-solutions/fallpharm-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallpharm-us-sdk/
- MCP wrapper: [`@ai-native-solutions/fallpharm-us-mcp`](https://github.com/sjgant80-hub/fallpharm-us-mcp)
- HTTP API: [`@ai-native-solutions/fallpharm-us-api`](https://github.com/sjgant80-hub/fallpharm-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallpharm-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallpharm-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallpharm-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallpharm-us-sdk -- npx -y @ai-native-solutions/fallpharm-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallpharm-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallpharm-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallpharm-us-sdk/
- **Source**: https://github.com/sjgant80-hub/fallpharm-us-sdk
